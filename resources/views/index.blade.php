                ...
                <div>
                    ...
                    <div class="gap-[30px] __scroll-selector">
                        ...
                        <div class="relative overflow-hidden group mr-[30px]">
                            ...
                            <!-- bottom detail -->
                            <div class="absolute bottom-0 h-[100px] left-0 right-0 bg-gradient-to-t from-black rounded-bl-[28px]
                                ...
                                <div
                                    class="translate-x-[100px] group-hover:translate-x-0 transition ease-in-out duration-500">
                        ...
                        <div class="relative overflow-hidden group mr-[30px]">
                            ...
                            <!-- bottom detail -->
                            <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black rounded-bl-[28px]
                                rounded-br-[28px] flex justify-between items-center px-7 h-[130px]">
                                <div>
                ...
                <div>
                    ...
                    <div class="__scroll-selector">
                        ...
                        <div class="relative group overflow-hidden mr-[30px]">
                            <img src="assets/images/browse-1.png"
                        ...
                        <!-- Movies 2 -->
                        <div class="relative group overflow-hidden mr-[30px]">
                            <img src="assets/images/browse-2.png"
                                class="object-cover rounded-[30px] h-[340px] w-[250px]" alt="">
                            <div
                                class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black rounded-bl-[28px] rounded-br-[28px]">
                                <div class="px-7 pb-7">
                        ...
                        <!-- Movies 3 -->
                        <div class="relative group overflow-hidden mr-[30px]">
                            <img src="assets/images/browse-3.png"
                                class="object-cover rounded-[30px] h-[340px] w-[250px]" alt="">
                            <div
                                class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black rounded-bl-[28px] rounded-br-[28px]">
                                <div class="px-7 pb-7">
                        ...
                        <!-- Movies 4 -->
                        <div class="relative group overflow-hidden mr-[30px]">
                            <img src="assets/images/browse-4.png"
                                class="object-cover rounded-[30px] h-[340px] w-[250px]" alt="">
                            <div
                                class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black rounded-bl-[28px] rounded-br-[28px]">
                                <div class="px-7 pb-7">
                        ...
                        <!-- Movies 5 -->
                        <div class="relative group overflow-hidden mr-[30px]">
                            <img src="assets/images/browse-5.png"
                                class="object-cover rounded-[30px] h-[340px] w-[250px]" alt="">
                            <div
                                class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black rounded-bl-[28px] rounded-br-[28px]">
                                <div class="px-7 pb-7">
